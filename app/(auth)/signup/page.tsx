      ...
      <div className="signup-card relative w-full max-w-[420px] rounded-[32px] border border-gray-100 bg-white p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
        ...
        <div className="flex justify-center mb-8">
          <Link href="/" className="signup-reveal group flex flex-col items-center">
            <div className="h-10 w-10 bg-black rounded-xl flex items-center justify-center text-white shadow-lg transition-transform group-hover:rotate-12">
               O
            </div>
          </Link>
        </div>
        ...
        <div className="text-center mb-10">
          <h1 className="signup-reveal text-3xl font-bold tracking-tighter text-[#141519]">
            Create Account
          </h1>
          <p className="signup-reveal mt-2 text-sm text-[#767F88] font-medium">
            Join the 2026 creative standard.
          </p>
        </div>
        ...
        <div ref={formRef} className="space-y-6">
          {step === 1 ? (
            <>
              ...
              <Button 
                onClick={nextStep}
                className="signup-reveal w-full h-12 rounded-xl bg-black text-white font-bold text-sm hover:bg-black/90 transition-all group"
              >
                Next Step
              ...
              <div className="signup-reveal grid grid-cols-2 gap-3">
                <Button variant="outline" className="h-11 rounded-xl border-[#E5E5E7] text-xs font-bold gap-2">
            ...
            <>
              {/* STEP 2: PROFILE MINIMAL */}
              <div className="flex flex-col items-center gap-6">
                <div className="signup-reveal relative group">
                  <div className="h-20 w-20 rounded-2xl bg-[#48E44B]/10 border border-[#48E44B]/20 flex items-center justify-center text-2xl group-hover:bg-[#48E44B]/20 transition-colors cursor-pointer">
                    ✨
                  </div>
                  <div className="absolute -bottom-1 -right-1 h-7 w-7 bg-black rounded-full border-2 border-white flex items-center justify-center text-white">
                    <Camera size={12} />
                  </div>
                </div>
                <div className="w-full space-y-4 text-left">
                  ...
                  <p className="signup-reveal text-[11px] text-[#767F88] text-center leading-relaxed">
              ...
              <Button 
                className="signup-reveal w-full h-12 rounded-xl bg-[#48E44B] text-black font-bold text-sm hover:bg-[#3ec741] shadow-lg shadow-[#48E44B]/20 transition-all"
              >
                Complete Setup
              </Button>
              
              <button onClick={() => setStep(1)} className="signup-reveal w-full text-[11px] font-bold text-[#767F88] hover:text-black">
                Go back
              </button>
            </>
          )}
